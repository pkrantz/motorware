...
// FILE:	F28052M.cmd
//
// TITLE:	Linker Command File For F28052M Device
//
//###########################################################################
...
// the memory map.
//
// The header linker files are found in <base>\F28052M_Headers\cmd
//
// For BIOS applications add:      F28052M_Headers_BIOS.cmd
// For nonBIOS applications add:   F28052M_Headers_nonBIOS.cmd
========================================================= */
...
/* -l F28052M_Headers_nonBIOS.cmd */

/* Uncomment this line to include file only for BIOS applications */
/* -l F28052M_Headers_BIOS.cmd */

/* 2) In your project add the path to <base>\F28052M_headers\cmd to the
...
/*   FLASHD			: origin = 0x3F2000, length = 0x002000		/* on-chip FLASH */
   FLASHC_E			: origin = 0x3F0000, length = 0x006000		/* on-chip FLASH */
...
SECTIONS
{
   ...
   .cinit			: > FLASHC_E			PAGE = 0
   .pinit			: > FLASHC_E,			PAGE = 0
   .text			: > FLASHC_E			PAGE = 0
   ...
   .econst			: > FLASHC_E			PAGE = 0
   .switch			: > FLASHC_E			PAGE = 0

   /* Allocate IQ math areas: */
   IQmath			: > FLASHC_E			PAGE = 0            /* Math Code */
   ...
   */
#ifdef POSITION // IQNexp tables required for position projects
